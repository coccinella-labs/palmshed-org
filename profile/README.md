...
Palmshed is a software organization. This GitHub organization is the public home for applications, developer tools, infrastructure, experiments, releases, and supporting source code.

## What is here

Repositories include applications, services, libraries, command-line tools, runtime components, experiments, release artifacts, and reference implementations. Some projects are complete, while others continue to evolve over time.
